...
var player_controller_exports = {};
__export(player_controller_exports, {
  getPlayer: () => getPlayer,
  getPlayerById: () => getPlayerById
});
module.exports = __toCommonJS(player_controller_exports);
...
// src/utils/http-status-helper.ts
var okStatus = (data) => __async(null, null, function* () {
  return {
    statusCode: 200,
    body: data
  };
});
var noContentStatus = () => __async(null, null, function* () {
  return {
    statusCode: 204,
    body: null
  };
...
var getPlayerService = () => __async(null, null, function* () {
  ...
  let response = null;
  if (data) {
    response = yield okStatus(data);
  } else {
    response = yield noContentStatus();
  }
  return response;
});
